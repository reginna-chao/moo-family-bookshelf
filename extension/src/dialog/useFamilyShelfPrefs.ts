 ...
 * `FamilyPrefsSync` controller (identical on the PWA); this hook only owns the
 * React state and wires the controller to mount / unmount and to the
 * `[userId, apiClient]` load trigger.
 */
