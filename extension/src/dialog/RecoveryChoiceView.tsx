...
export function RecoveryChoiceView({
  ...
  const secondaryClass = isLoading
    ? "moo-button moo-button--outline moo-button--block moo-recovery-choice__secondary moo-recovery-choice__secondary--loading"
    : "moo-button moo-button--outline moo-button--block moo-recovery-choice__secondary";
  return (
    <div className="moo-onboarding-view">
      <h2 className="moo-onboarding-view__heading">發現您的家庭書架帳號</h2>
      {userEmail && (
        <p className="moo-recovery-choice__account">帳號：{userEmail}</p>
      )}
      ...
      <button
        ...
        className="moo-button moo-button--block moo-recovery-choice__primary"
      >
        輸入同步碼重新加入
      </button>
      <button
