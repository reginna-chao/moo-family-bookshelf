...
export const BookRow = React.memo(function BookRow({
  ...
  const rowClass = selected
    ? "moo-shelf-row moo-shelf-row--selected"
    : "moo-shelf-row";
  const toggleClass = isOn
    ? "moo-shelf-row__toggle moo-shelf-row__toggle--on"
    : "moo-shelf-row__toggle";
  ...
  return (
    <div onClick={handleRowClick} className={rowClass}>
      ...
      <div className="moo-shelf-row__info">
        ...
        {book.author && (
          <div className="moo-shelf-row__author">{book.author}</div>
        )}
      </div>
      <button
        data-toggle-btn
