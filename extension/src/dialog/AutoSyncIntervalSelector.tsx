...
export function AutoSyncIntervalSelector({
  value,
  onChange,
}: AutoSyncIntervalSelectorProps) {
  ...
  return (
    <select
      ...
      className={
        isMobile
          ? "moo-form-input moo-form-input--select moo-form-input--mobile moo-form-select moo-form-select--mobile"
          : "moo-form-input moo-form-input--select moo-form-select"
      }
    >
      {OPTIONS.map((opt) => (
